...
| :--- | :--- | :--- |
| `{{site.versions.sdk}}` | **MapTiler SDK JS** | `v4.0.3` |
...
## Usage for CDN
- **SDK JS Script:** `https://cdn.maptiler.com/maptiler-sdk-js/v4.0.3/maptiler-sdk.umd.min.js`
- **SDK JS CSS:** `https://cdn.maptiler.com/maptiler-sdk-js/v4.0.3/maptiler-sdk.css`
