# Source: https://docs.maptiler.com/sdk-js/examples/marker-layout-weather/

# MapTiler Marker Layout

Create a weather map using the [Marker Layout](/sdk-js/modules/marker-layout/) to show your custom weather markers icons, animated SVGs or Lotties. In this example, we use the MapTiler SDK together with the [MapTiler Weather library](/sdk-js/modules/weather/).
...
> If you prefer to follow this example using TypeScript and ES modules, check out the demo that we have prepared in the [Marker Layout library's GitHub repository](https://github.com/maptiler/maptiler-marker-layout/tree/main/demos/weather-es).
