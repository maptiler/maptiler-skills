# Source: https://docs.maptiler.com/sdk-js/examples/popup-on-hover/

# Display a popup on hover

When a user hovers over a custom marker, show a [`Popup`](/sdk-js/api/markers/#popup) containing more information.
